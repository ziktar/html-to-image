        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cloneNode(iframe.contentDocument.body, { stripStaticAndFixed: true }, true)];
                case 1:
                    clonedIframe = (_c.sent());
                    clonedIframe.style.setProperty('position', 'relative');
                    return [2 /*return*/, clonedIframe];
...
function cloneCSSStyle(nativeNode, clonedNode, stripStaticAndFixed) {
    ...
    if (sourceStyle.cssText) {
        ...
        var nodeIsIFrame_1 = (0, util_1.isInstanceOfElement)(nativeNode, HTMLIFrameElement);
        (0, util_1.getStyleProperties)().forEach(function (name) {
            ...
            if (nodeIsIFrame_1 && name === 'display' && value === 'inline') {
                value = 'block';
            }
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, Promise.resolve(node)
                    ...
                    .then(function (clonedNode) { return decorate(node, clonedNode, options.stripStaticAndFixed); })
