...
function getStyleProperties() {
    ...
    styleProps = toArray(window.getComputedStyle(document.documentElement)).filter(function (prop) {
        var strProp = String(prop);
        ...
        return __generator(this, function (_a) {
            ...
            if (navigator.userAgent.match(/Firefox\/(\d+)\./) || (navigator.userAgent.match(/Safari\/(\d+)\./) && !navigator.userAgent.match(/Chrome\/(\d+)\./))) {
                return [2 /*return*/, Promise.resolve()
                        ...
                        .then(function (svg) { return new Blob([svg], { type: 'image/svg+xml' }); })
