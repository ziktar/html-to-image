...
function toSvg(node, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _a, width, height, clonedNode, styleNode, styleContent, datauri;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (options.embedStyle) {
                        ...
                        styleContent = document.createTextNode(options.embedStyle);
...
function toCanvas(node, options) {
    if (options === void 0) { options = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var _a, width, height, svg, img, canvas, context, ratio, canvasWidth, canvasHeight, margin, canvasBackgroundColor;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, util_1.getImageSize)(node, options), width = _a.width, height = _a.height;
                ...
                case 2:
                    ...
                    canvasBackgroundColor = options.marginBackgroundColor || options.backgroundColor;
